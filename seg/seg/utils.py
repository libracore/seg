...
def update_item_prices(currency, currency_exchange_fee):
    ...
    if old_fee != currency_exchange_fee:
        ...
        for affected_price in affected_prices:
            ...
            frappe.log_error(currency_exchange_fee, "currency_exchange_fee")
